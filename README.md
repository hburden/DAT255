...
The majority of the course work is done in project teams. The topic this time is within maritime IT and the case is to tailor a generic app for the specific needs and wishes of one of the actors operating in a port. The existing application can be found both on [Google Play](https://play.google.com/store/apps/details?id=se.viktoria.portablecdm&hl=en) and the [App Store](https://itunes.apple.com/US/app/id1278240361?mt=8). The source code of the app can be forked from the [github repo](https://github.com/avajadi/portablecdm). There is a sandboxed [backend](http://sandbox-6.portcdm.eu) that you can connect to as well. To give you an initial idea of the needs and wishes of the actors there is a [scenario][scenario] that describes typical port operations and their dependencies. The aim is to have ten teams so you will be approximately eight students per team. 
