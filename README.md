...
- D1: A one-page document drawing on the lessons from the Lego scrum exercise on how to initially work with scrum. Describe three strategies for improving how you implement Scrum in your project. An strategy can be that you want to do more or less of a practice, or that you want to change how you applied a practice. Mention how the strategy will be managed. We also want a [social contract][socialcontract] for the team. Both the scoial contract and the strategies should be uploaded to the team git repo before Mar 24 17.00. The strategies should also be e-mailed to HB before Mar 24 17.00. 
- D2: Choose three KPIs to monitor your implementation of Scrum. Motivate your choice and upload the document to the team git repo before Mar 31 17.00.
- D3A: An initial product backlog. E-mail an invitation to your scrum board to JS before Apr 04 17.00. You are free to choose any scrum board technology you want but make sure you can share it.
- D3B: A business model for your system. To be uploaded to the team git repo before Apr 07 17.00.
